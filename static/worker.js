(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('node-fetch'), require('rxjs'), require('rxjs/internal-compatibility'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define(['exports', 'node-fetch', 'rxjs', 'rxjs/internal-compatibility', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.self = global.self || {}, global.nodeFetch, global.rxjs, global.internalCompatibility, global.operators));
}(this, (function (exports, nodeFetch, rxjs, internalCompatibility, operators) { 'use strict';

    function get(url) {
        return internalCompatibility.fromPromise(fetch(new nodeFetch.Request(url)))
            ...
            .pipe(operators.switchMap(response => {
                if (typeof response['json'] === 'function') {
                    const res = response;
                    return internalCompatibility.fromPromise(res.json());
                } else {
                    return response;
                }
            }));
