...
To create custom shaders for use with `@svelte/gl`, I had to make some changes to the `gl` source, beginning by adding a declaration to all shaders compile by `Material.mjs`:
