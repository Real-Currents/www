...
```{r image, cache = FALSE, echo = FALSE, results = "asis"}
...
jsonlite::write_json(heights, "data/terrain-heights.json")
jsonlite::write_json(vertices, "data/terrain-verts.json")
jsonlite::write_json(normals, "data/terrain-norms.json")
jsonlite::write_json(textureCoords, "data/terrain-uvs.json")
jsonlite::write_json(knitTriangleIndices(image_width, image_height), "data/terrain-idx.json")
```
