...
<div id="stream" style="text-align:center" onclick="(function(evt) { evt.target.innerHTML='Now Playing'; evt.target.parentElement.style.display='none'; evt.target.onclick = null; window.userTriggered=true; }) (event || window.event)">
<a id="aud1_play" href="revealing/#">Play</a>
&nbsp;<br /><br />
