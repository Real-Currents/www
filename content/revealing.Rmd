...
<a id="aud1_play" href="revealing/#"  onclick="(function(evt) { evt.target.innerHTML='Now Playing'; evt.target.onclick = null; window.userTriggered=true; }) (event || window.event)">Play</a><br />
